    ...
    <div className="credit-card">
      <div className="credit-card__inner">
        <div className="credit-card__front">
          <img src="/laplace.svg" alt="Laplace" className="logo" />
          <div className="chip">
          ...
          <div className="credit-card-number">
            <div className="section">4687</div>
            <div className="section">1234</div>
            <div className="section">6788</div>
            <div className="section">3899</div>
          </div>
          <div className="credit-card-info__bottom">
            <div className="credit-card-holder">John Doe</div>
            <div className="credit-card-info__right">
              <div className="exp-date">05/27</div>
              <div className="mastercredit-card">
        ...
        <div className="credit-card__back">
          ...
          <div className="credit-card-signature-wrapper">
            <div className="credit-card-signature-field">
              <div className="credit-card-signature-headline">
                Authorized Signature
              </div>
              <div className="credit-card-signature">David Mraz</div>
            </div>
            <div className="credit-card-ccv">123</div>
          </div>
        </div>
      </div>
    </div>
