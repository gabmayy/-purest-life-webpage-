  ...
  const cards = [
    {
      ...
      imageName: "main-desktop-1", // image for the card
    ...
    {
      title:
        "ISO+ Proteína Aislada de Suero More Than Pure sabor VainillaISO+ Proteína Aislada de Suero More Than Pure sabor Vainilla",
      price: "$450.00",
      longDescription:
    ...
    {
      title: "ISO WOMAN 1.8 kgISO WOMAN 1.8 kg",
      price: "$890.00",
      longDescription:
    ...
    {
      title: "Atomic Preworkout 300gAtomic Preworkout 300g",
      price: "$450.00",
      longDescription:
